...
var NioApp = (function (jQ, win, doc){
    "use strict";
    var NioApp = {AppInfo: {name: "ICOCrypto", package: "1.9.2", version: "1.0.4", author: "xxx"} },
    ...
    NioApp.Plugins.carousel = function () {
        ...
        if ($carousel.exists()) {
            $carousel.each(function () {
                var $self = $(this);
                var cim = ($self.data('items')) ? $self.data('items') : 2;
                ...
                $self.addClass('owl-carousel').owlCarousel({
                    ...
                    responsive:{
                        ...
                        992:{ items: 4, margin: c_mgn_t_l },
                        1200:{ items: 4, margin: c_mgn },
                        1600:{ items: 4, margin: c_mgn }
                    },
